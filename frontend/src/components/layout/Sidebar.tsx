...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      {/* Contenedor Sidebar */}
      <aside
        className={`fixed left-0 h-full top-0 z-45 w-72 bg-slate-950 text-slate-300 transition-all duration-300 ease-in-out border-r border-slate-800 lg:translate-x-0 ${isOpen ? 'translate-x-0 shadow-2xl' : '-translate-x-full'
          }`}
      >
